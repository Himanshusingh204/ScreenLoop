    ...
    <div className="page-wrapper">
      ...
      <main className="about-page-content">
        ...
        >
          ...
          {/* Mission & Philosophy — Split 2-Column Layout */}
          <motion.section className="about-story-section" variants={fadeInUp}>
            <div className="about-split">
              <div className="about-split-sticky glass-card" style={{ padding: 'var(--space-8)', borderRadius: 'var(--radius-xl)' }}>
              ...
              <div className="about-split-right">
                <div className="arch-step-card glass-card">
          ...
          <motion.section className="about-specs-section" variants={fadeInUp}>
            ...
            <div className="about-specs-grid">
              {TECH_SPECS.map((spec, idx) => (
                <div key={idx} className="spec-item-card glass-card">
          ...
          <motion.section className="about-oss-section" variants={fadeInUp}>
            <div className="about-oss-card glass-card">
